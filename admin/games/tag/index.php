...
$tags = getTags();
$tags = getGames($tags , 'tags'); // get how many games are active for this tags
$gamemenu='active';
$datatables='active';
?>
<!DOCTYPE html>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1><?php echo $lang[24] ?><small><?php echo $lang[40] ?></small></h1>
				<ol class="breadcrumb">
					...
					<li class="active"><?php echo $lang[24] ?></li>
				</ol>
			</section><!-- /.content-header -->

			<!-- Main content -->
			<section class="content">
				<?php include $basedir . '/admin/games/tag/gamestagbody.php'; ?>
			</section><!-- /.content -->
