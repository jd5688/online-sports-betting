...
<body>
	...
	<p class="notice">This game will start at 2013/9/21 12:00</p>
			...
			<aside id="sidebar" role="betform" class="col span_4">
				<div class="floating-widget">
					...
					<h3 class="title">
						...
						<span class="title time">BET start time</span>
						<div class="timer_cd" id="game105">Time Up</div>
						<script language="JavaScript" type="text/javascript">
							cdTimer1();
							function cdTimer1()	{
								var	elemID = 'game105';
						...
						<span>Choose Item and BET this below</span>
					</h3>
					<div class="inner">
					...
					<a href="" class="bet btn disabled">Coming soon</a>
